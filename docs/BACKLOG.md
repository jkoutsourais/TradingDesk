...
- **Book maintenance lane and holdings ratings (Phase 6).** The idea desk skips held instruments; the holdings desk's daily ratings and the book maintenance lane (stops near, expiries, size drift) arrive with the analyst desk's debates.
...
- **Full chat (Phase 9).** Phase 5 intake only drafts and confirms theses; the chief-of-staff chat (questions about the desk, ELI5 explanations) comes with the dashboard.
